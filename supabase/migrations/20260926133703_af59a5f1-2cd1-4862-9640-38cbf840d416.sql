...
GRANT SELECT ON public.customer_package_credits TO authenticated;
GRANT ALL ON public.customer_package_credits TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.customer_subscription_plans TO authenticated;
GRANT ALL ON public.customer_subscription_plans TO service_role;
...
GRANT SELECT, INSERT, UPDATE, DELETE ON public.customer_subscription_plan_items TO authenticated;
GRANT ALL ON public.customer_subscription_plan_items TO service_role;
...
GRANT SELECT ON public.customer_service_subscriptions TO authenticated;
GRANT ALL ON public.customer_service_subscriptions TO service_role;
...
GRANT SELECT ON public.customer_subscription_cycles TO authenticated;
GRANT ALL ON public.customer_subscription_cycles TO service_role;
...
GRANT SELECT ON public.customer_subscription_credits TO authenticated;
GRANT ALL ON public.customer_subscription_credits TO service_role;
...
GRANT SELECT ON public.service_benefit_consumptions TO authenticated;
GRANT ALL ON public.service_benefit_consumptions TO service_role;
...
CREATE POLICY tenant_manage_packages ON public.service_packages FOR ALL TO authenticated USING(is_establishment_admin(establishment_id,auth.uid())) WITH CHECK(is_establishment_admin(establishment_id,auth.uid()));
CREATE POLICY tenant_manage_package_items ON public.service_package_items FOR ALL TO authenticated USING(is_establishment_admin(establishment_id,auth.uid())) WITH CHECK(is_establishment_admin(establishment_id,auth.uid()));
CREATE POLICY tenant_manage_plans ON public.customer_subscription_plans FOR ALL TO authenticated USING(is_establishment_admin(establishment_id,auth.uid())) WITH CHECK(is_establishment_admin(establishment_id,auth.uid()));
CREATE POLICY tenant_manage_plan_items ON public.customer_subscription_plan_items FOR ALL TO authenticated USING(is_establishment_admin(establishment_id,auth.uid())) WITH CHECK(is_establishment_admin(establishment_id,auth.uid()));
